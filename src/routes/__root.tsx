...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RW 02 Pedurungan Kidul — Semarang" },
      {
        name: "description",
        content:
          "Website resmi RW 02 Kelurahan Pedurungan Kidul, Kecamatan Pedurungan, Kota Semarang. Informasi warga, pengumuman, dan kegiatan RT/RW.",
      },
      { name: "author", content: "RW 02 Pedurungan Kidul" },
